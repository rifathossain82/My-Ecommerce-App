...
public class Offer_items extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_offer_items, container, false);

        recyclerView=view.findViewById(R.id.recyclcerview_id_offer_items);
