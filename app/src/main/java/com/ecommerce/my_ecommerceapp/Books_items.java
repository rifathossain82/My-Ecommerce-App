...
public class Books_items extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_books_items, container, false);

        recyclerView=view.findViewById(R.id.recyclcerview_id_books_items);
