...
public class Home_appliances_items extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_home_appliances_items, container, false);

        recyclerView=view.findViewById(R.id.recyclcerview_id_home_appliances_items);
