...
public class Lifestyle_items extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_lifestyle_items, container, false);

        recyclerView=view.findViewById(R.id.recyclcerview_id_lifestyle_items);
